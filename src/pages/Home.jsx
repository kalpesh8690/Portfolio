...
// UI / social / general icons from MUI
import {
...
const Home = () => {
  ...
  const stats = [
    { icon: WorkIcon, value: "2+", label: "Years Experience" },
    { icon: LaptopMacIcon, value: "20+", label: "Projects Completed" },
    { icon: CodeIcon, value: "15+", label: "Happy Clients" },
  ];
  ...
  const skills = [
    {
      ...
      items: [
        { Icon: SiReact, name: "React.js", level: "Advanced" },
    ...
    },
    {
      ...
      items: [
        { Icon: SiNodedotjs, name: "Node.js", level: "Advanced" },
    ...
    },
    {
      ...
      items: [
        ...
        // { Icon: SiAmazonaws, name: "AWS", level: "Basic" },
      ],
    },
  ];
        ...
        <div className="hero-content">
          <div className="text-content">
            ...
            <p className="intro">
              ...
              clean code and innovative solutions. Specializing in full-stack
            ...
            <div className="cta-group">
              ...
              <div className="action-buttons">
                <button onClick={navigation.contact} className="primary-button">
                  Let's Connect <ArrowForwardIcon />
                </button>
                <button onClick={navigation.cv} className="secondary-button">
                  <DownloadIcon /> Resume
                </button>
                <button
                ...
                {category.items.map((skill, skillIndex) => (
                  <div key={skillIndex} className="skill-card">
                    ...
                    <div className="skill-level">
                      <span
                        className={`level-indicator ${skill.level.toLowerCase()}`}
                      >
                        {skill.level}
                      </span>
                    </div>
      ...
      <div className="cta-div">
        <div className="cta-content">
          ...
          <div className="cta-buttons">
            ...
            >
              View Projects <ArrowForwardIcon className="button-icon" />
            </button>
            <button
            ...
            >
              Get in Touch <EmailIcon className="button-icon" />
            </button>
          </div>
        </div>
      </div>
